...
void main()
{
	...
	if(bool(dist[0] & 128)) dist[0] = -(dist[0] ^ 128);
	if(bool(dist[1] & 128)) dist[1] = -(dist[1] ^ 128);
	if(bool(dist[2] & 128)) dist[2] = -(dist[2] ^ 128);
	if(bool(dist[3] & 128)) dist[3] = -(dist[3] ^ 128);
	if(bool(dist[4] & 128)) dist[4] = -(dist[4] ^ 128);
	if(bool(dist[5] & 128)) dist[5] = -(dist[5] ^ 128);
	if(bool(dist[6] & 128)) dist[6] = -(dist[6] ^ 128);
	if(bool(dist[7] & 128)) dist[7] = -(dist[7] ^ 128);
